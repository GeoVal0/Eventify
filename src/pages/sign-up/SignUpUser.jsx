...
//   // Αν έχεις βάλει συνάρτηση ελέγχου (validation) για τα πεδία, 
//   // μπορείς να την αφήσεις να τρέξει εδώ:
//   // if (!validateInputs()) return;

//   console.log("Γίνεται ψεύτικη αποστολή δεδομένων...");

//   // Βάζουμε μια μικρή καθυστέρηση (π.χ. 500ms) για να προσομοιώσουμε 
//   // το χρόνο που θα έκανε ο server να απαντήσει
//   setTimeout(() => {
